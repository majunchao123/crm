...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
           ...
           $(this).children("div").children("div").show();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            ...
                            //刷新备注列表
                            var htmlStr = "";
                            htmlStr += "<div class=\"remarkDiv\" id=\"div_" + data.otherData.id + "\" style=\"height: 60px;\">";
                            htmlStr += "<img title=\"" + data.otherData.createBy + "\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">";
                            ...
                            htmlStr += "<b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small";
                            htmlStr += "style=\"color: gray;\"> " + data.otherData.createTime + "由" + data.otherData.createBy + "创建</small>";
                            htmlStr += "<div style=\"position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;\">";
                            htmlStr += "<a class=\"myHref\" name=\"editA\" remarkId=\"" + data.otherData.id + "\" href=\"javascript:void(0);\"><spanclass=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
                            htmlStr += "&nbsp;&nbsp;&nbsp;&nbsp;";
                            htmlStr += "<a class=\"myHref\"name=\"deleteA\" remarkId=\"" + data.otherData.id + "\" href=\"javascript:void(0);\"><spanclass=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
                            htmlStr += "</div>";
                            htmlStr += "</div>";
                            htmlStr += "</div>";
                            //拼接上
            ...
            $("#bundActivityBtn").on("click",function () {
                ...
                var activityName = "";
                var clueId = '${clue.id}';
                queryActByCondition(activityName,clueId);
                //弹出"线索关联市场活动"的模态窗口
            ...
            $("#saveBundActivityBtn").click(function () {
             ...
             $.each(checkedIds,function () {
                ...
                //发送请求
                $.ajax({
                    url: 'workbench/clue/saveBoundActClueRelation.do',
                    data:ids,
                    type:'post',
                    dataType:'json',
                    success:function (data) {
                        if (data.code=="1"){
                            ...
                            //拼接tbody
                                var htmlStr ="";
                                $.each(data.otherData,function (index,obj) {
                                    htmlStr +="<tr id=\"tr_"+obj.id+"\">";
                                    htmlStr +="<td>"+ obj.name+"</td>";
                                    htmlStr +="<td>"+obj.startDate+"</td>";
                                    htmlStr +="<td>"+obj.endDate+"</td>";
                                    htmlStr +="<td>"+obj.owner+"</td>";
                                    htmlStr +="<td><a href=\"javascript:void(0);\" style=\"text-decoration: none;\"><spanclass=\"glyphicon glyphicon-remove\"></span>解除关联</a></td>";
                                    htmlStr +="</tr>";
                                });
                                $("#relationedTBody").before(htmlStr);
                        } else {
                            alert(data.message);
                            //模态窗口不关闭
                            $("#bundModal").modal("show")
        ...
        //封装查询没有关联过的市场活动
        function queryActByCondition(activityName,clueId){
            //发送请求
            $.ajax({
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input id="searchActTxt" type="text" class="form-control" style="width: 300px;"
...
<div id="remarkDivList" style="position: relative; top: 40px; left: 40px;">
    ...
    <%--<div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;" >
            ...
            <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                <a class="myHref" name="updateA" remarkId="" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
