    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#searchActBtn").click(function () {
                ...
                var activityName = "";
                //显示所有关联过的市场活动
                queryIncludeActByCondition(activityName, clueId);
                //显示模态窗口
        ...
        //封装查询关联过的市场活动
        function queryIncludeActByCondition(activityName, clueId) {
            //发送请求
            $.ajax({
                url: 'workbench/clue/queryIncludeActivityByNameClueId.do',
                data: {
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" id="searchActTxt" class="form-control" style="width: 300px;"
    ...
    <form>
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            ...
            <select id="stage" class="form-control">
                <option></option>
                <c:forEach items="${valueList}" var="vl">
                    <option value="${vl.id}">${vl.value}</option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchActBtn"
